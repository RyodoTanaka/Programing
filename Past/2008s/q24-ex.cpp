...
int main(int argc, char** argv)
{
  ...
  for(int v_max=2; flg; v_max++){
	...
	// 平均クラスタ係数を求める
	double avg_cluster = accumulate(cluster.begin(),cluster.end(),0.0)/(double)cluster.size();
	cout << "Avg : " << avg_cluster << endl;
	cout << v_max << endl;
  }
